...
export const MOCK_COST_CODES = [
  { code: 'AMIX-24-05', description: 'Dredging Ops - Fraser River' },
  { code: 'AMIX-24-08', description: 'Pile Driving - North Shore' },
  { code: 'EQ-TUG-01', description: 'Tugboat Maintenance' },
  { code: 'EQ-BARGE-22', description: 'Barge Repair' },
  { code: 'FUEL-DSL', description: 'Diesel Fuel' },
  { code: 'SAFE-PPE', description: 'Safety Equipment' },
  { code: 'ADMIN-GEN', description: 'General Office' },
];
...
export const Icons = {
  ...
  Receipt: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <line x1="14" y1="8" x2="8" y2="8"></line>
  ...
  Boat: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M10 10V4a2 2 0 0 1 2-2 2 2 0 0 1 2 2v6"></path>
